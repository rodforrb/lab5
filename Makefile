...
prr: driver.o list.o CPU.o schedule_pri_rr.o
	$(CC) $(CFLAGS) -o prr driver.o schedule_pri_rr.o list.o CPU.o
...
schedule_pri_rr.o: schedule_pri_rr.c
	$(CC) $(CFLAGS) -c schedule_pri_rr.c
